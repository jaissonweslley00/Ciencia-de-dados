...
async function visualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `Você sabia que o mundo tem ${dados.total_pessoas_mundo} de pessoas e que aproximadamente ${dados.total_pessoas_conectadas} estão conectadas em alguma rede social e passam em média </span> $ {horas} </span> ${dados.tempo_medio} horas e <span>${minutos}</span> minutos conectadas.`
